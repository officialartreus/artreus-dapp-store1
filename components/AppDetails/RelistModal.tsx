...
export default function RelistModal({ setIsOpen, isOpen, token_id }) {
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <button className='w-fit bg-[#6039CF] p-2 rounded-lg' >Store</button>
                                        </div>
                                        ...
                                        <div className='flex flex-col mt-5'>
                                            ...
                                            <button className='w-fit bg-[#6039CF] p-2 rounded-lg' >Relist</button>
                                        </div>
